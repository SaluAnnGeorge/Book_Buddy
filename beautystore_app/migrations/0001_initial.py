# Generated by Django 5.0.4 on 2024-09-18 06:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='beautystore_app.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beautystore_app.address')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beautystore_app.customer')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beautystore_app.order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beautystore_app.product')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beautystore_app.product')),
                ('PurchaseOrder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beautystore_app.purchaseorder')),
            ],
        ),
        migrations.CreateModel(
            name='Seller',
        ...
        migrations.AddField(
            ...
            name='Seller',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beautystore_app.seller'),
        ),
        migrations.AddField(
            model_name='product',
            name='seller',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beautystore_app.category')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='subcategory',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beautystore_app.subcategory'),
        ),
        migrations.CreateModel(
            name='Wishlist',
            fields=[
